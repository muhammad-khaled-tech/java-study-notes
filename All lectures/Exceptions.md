...
**(قاعدة الوراثة الصارمة)** **(Source:,)** دي قاعدة بتكسر جونيورز كتير في الإنترفيوهات. لو `Parent` عنده ميثود بترمي `IOException`، الـ `Child` اللي بيعمل Override للميثود دي:
